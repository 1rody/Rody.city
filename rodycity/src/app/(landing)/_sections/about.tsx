...
export default function About() { 
    ...
    return (
        <>
        <Image className=' z-10 relative image flex items-center justify-center' width={3000} height={700} src='assets/transition3.svg' alt='transition img'/>
        <section ref={stripesRef} className="z-3 relative stripes-row overflow-hidden w-full gap-5 align-center justify-center font-inter text-8xl flex flex-col">
                ...
                <section className='z-2 items-center justify-center globe-grow globe flex'>
                    ...
                    <Globe size={480} className="no-invert grow-unshow-anim" />
                </section>
        ...
        <Image className='mt-20 z-10 relative image flex items-center justify-center' width={3000} height={700} src='assets/transition3.svg' alt='transition img'/>
        <section ref={aboutRef}  id='whoami' className="how-pricing flex flex-col secondary-bg items-center justify-center ">
                    <div className='whoami-group flex items-center justify-center'>
                        <Image className='no-invert mt-50 image flex items-center justify-center' width={1100} height={800} src='/assets/whoami.svg' alt='whoamibanner'/>
                    </div>
                    <div id='about' className='about-rody w-full items-center justify-center flex-wrap flex flex-col gap-2 '>
        ...
        <Image className='no-invert image flex items-center justify-center' height={50} width={3000} src='assets/transition-black.svg' alt='transition img'/>
