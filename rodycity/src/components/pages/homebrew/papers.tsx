  ...
  const papers: Paper[] = [
    ...
    return (
        <section className="justify-center font-departure font-bold  w-full overflow-hidden text-gray-50 flex flex-col items-center">
                    ...
                    <nav className='w-full flex-nowrap flex items-center justify-between lg:pr-5 lg:pl-5 border-1 bg-gray-950/30  border-gray-200/10 border-b-gray-950'>
                    ...
                    <div className='flex flex-wrap lg:flex-nowrap border-1 w-full  border-gray-200/10'>
