...
export default function Journey() {
    return (
        <>
            <Stripes />
            <section id="journey" className='flex lg:gap-24 gap-5 pt-50 bg-black pb-50 flex-wrap  lg:mt-300 md:mt-320 mt-300 z-10 overflow-hidden justify-center  w-full'>
                <div  className="mt-60">
