...
export default function Hero() {
    ...
    return (
        <section id="introduction" className="hero z-5 no-select h-screen flex flex-col w-full overflow-hidden">
            <div className="hover-show-group text-(--foreground) scale-95  text-center flex-wrap  flex items-center justify-center absolute w-full h-screen">
                <h1 className='nav-pc mb-46 text-8xl'>ENGINEER </h1>
                ...
                <h1 className='nav-pc mt-46 text-8xl'>WHAT&apos;S NEXT.</h1>
            </div>

            <div className="absolute -bottom-14 lg:bottom-8 md:-bottom-24 w-full lg:-mb-46 mb:-mb-25 sm:-mb-5 flex justify-center overflow-hidden">
