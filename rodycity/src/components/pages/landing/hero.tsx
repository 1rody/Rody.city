...
export default function Hero() {
    ...
    return (
        <section id="introduction" className="hero z-5 no-select h-screen flex flex-col w-full overflow-hidden">
            <div className="hover-show-group text-(--foreground) scale-95 md:scale-65 text-center flex-wrap  flex items-center justify-center absolute w-full h-screen">
                <h1 className='nav-pc mb-46 text-7xl '>ENGINEER </h1>
                ...
                <h1 className='nav-pc mt-46 text-7xl'>WHAT&apos;S NEXT</h1>
            </div>
