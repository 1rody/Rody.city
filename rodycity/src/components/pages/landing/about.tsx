    ...
    return (
        <>
            ...
            <section id="about" className="flex z-10 material-white items-center justify-center flex-col">
                <div className='flex sm:max-w-4/5 md:max-w-5/5 lg:max-w-4/7 w-full pb-50  flex-col p-10 dashed-stroke-tertiary'>
                    ...
                    <div className='flex flex-wrap lg:flex-nowrap gap-5 w-full'>
                        <article className='bg-(--background) p-10 rounded-3xl '>
                            <h2 className='text-(length:--super-large-text-secondary) font-black'>RODY</h2>
                            <p className='text-xl'>
                        ...
                        <div className='flex flex-col justify-between w-5/5 '>
                            <div className='flex mb-20 flex-col gap-5'>
                                <Link className='text-3xl text-black ' href="#">Github</Link>
