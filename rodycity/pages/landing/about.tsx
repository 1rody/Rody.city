...
export default function About() { 
    ...
    return (
        ...
        <Image className=' image flex items-center justify-center' width={3000} height={2000} src={whiteTransition} alt='transition img'/>
        <section ref={aboutRef}  id='whoami' className="how-pricing flex flex-col secondary-bg items-center justify-center">
                    <div className='whoami-group flex items-center justify-center'>
                        <Image className=' image flex items-center justify-center' width={1100} height={600} src={WhoamiBanner} alt='whoamibanner'/>
                    </div>
        ...
        <Image className=' image flex items-center justify-center' height={1000} width={3000} src={blackTransition} alt='transition img'/>
