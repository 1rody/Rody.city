                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <form className='flex items-end flex-col mt-10 mb-5 justify-center gap-4'>
                        <div className='flex gap-5'>
                            <input value={resultQuantity} onChange={(e) => setQuantityNumber(Number(e.target.value))}  className='text-2xl' id="drawn-results" type="number" min={1} max={100} required placeholder="Max Results" />
                            <input value={minNumber} onChange={(e) => setMinNumber(Number(e.target.value))} className='text-2xl' id="drawn-start" type="number" min={1} max={100} required placeholder='Start number'/>
                            <input value={maxNumber} onChange={(e) => setMaxNumber(Number(e.target.value))} className='text-2xl' id="drawn-end" type="number" min={1} max={100} required placeholder='Max number'/>
                        </div>
