...
//css
import './landing_styles/stripes.css'
import './landing_styles/about.css'
...
import blackTransition from '@/public/assets/transition-black.svg'
import WhoamiBanner from '@/public/assets/whoami.svg';
...
export default function About() { 
    ...
    return (
        <>
        <section ref={stripesRef} className="stripes-row overflow-hidden w-full gap-5 align-center justify-center font-inter text-8xl flex flex-col">
                <div className='z-2 items-center justify-center globe-grow globe flex'>
                    <Globe size={480} className="grow-unshow-anim" />
                </div>
                <section className='overflow-hidden '>
                    {['A web of ideasA web of ideas A web of ideas A web of ideas A web of ideas A web of ideas A web of ideas '].map((phrases) => (
                    <div key={phrases} className='container-stripes'>
        ...
        <Image className=' image flex items-center justify-center' width={3000} src={whiteTransition} alt='transition img'/>
        <section ref={aboutRef}  id='whoami' className="how-pricing flex flex-col secondary-bg items-center justify-center">
                    <div className='whoami-group flex items-center justify-center'>
                        <Image className=' image flex items-center justify-center' width={1100} src={WhoamiBanner} alt='whoamibanner'/>
                    </div>
                    <div id='about' className='about-rody flex-wrap flex flex-col gap-4'>
                            <div className='flex flex-col whoami-group gap-4'>
                                <article className='text-xl text-left p-8 flex flex-col gap-6'>
                                    <p>
                                        Hi, I'm Rodolfo, but you can call me Rody. <br />
                                        I'm a passionate front-end developer dedicated to building innovative interfaces using modern technologies
                                        like Next.js, React, and EJS. Currently, <br /> <br />
                                        I'm pursuing a degree in Software Engineering at UCSal while expanding my skills through Origamid and Rocketseat.
                                    </p>
                                </article>
                                <article className='text-xl text-left p-8 flex flex-col gap-6'>
                                    <p>
                            ...
                            <section className='tech-stack whoami-group flex flex-wrap items-center justify-between gap-3 mt-4 w-full'>
                    ...
                    <div className="container-prices  flex-wrap items-center justify-center flex flex-warp gap-3">
        ...
        <Image className=' image flex items-center justify-center' width={3000} src={blackTransition} alt='transition img'/>
