...
export default function projects() {
    return (
        ...
        <section id="projects-showing" className="flex gap-5 flex-col w-full mb-50 items-center overflow-hidden">
            <Image className=' items-center font-erika no-event user-select-none' src='assets/featured.svg' width={1000} height={50} alt="FeaturedBanner" />
            <div className="project-row">
                <article className="project-container items-center flex justify-center flex-wrap">
